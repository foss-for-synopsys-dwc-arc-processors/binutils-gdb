...
extern unsigned int arcv_apex_sub_opcode_from_xs_match (uint32_t);
...
#define ARCV_APEX_OP_MASK_RS2  0x1f
#define ARCV_APEX_OP_SH_RS2   20
#define ARCV_APEX_OP_MASK_RS1  0x1f
#define ARCV_APEX_OP_SH_RS1   15
#define ARCV_APEX_OP_MASK_RD   0x1f
#define ARCV_APEX_OP_SH_RD    7

#define ARCV_APEX_EXTRACT_XS_ITYPE_IMM(x) \
  (RV_X(x, 24, 8) | (RV_IMM_SIGN(x) << 8))

#define ARCV_APEX_EXTRACT_XI_XC_ITYPE_IMM(x) \
  (RV_X(x, 20, 12) | (RV_IMM_SIGN(x) << 12))
