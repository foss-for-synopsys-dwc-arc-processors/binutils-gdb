...
/* commute sub to do the following three operations */
  ...
  { "sbc%.f%Q %A,%L,%L%F", 0xffff7fc0, 0x26037f80, ARCOMPACT, 0, 0 ,0,0},
...
/* commute rsub to do the following three operations */
  ...
  { "sub2%.f%Q %A,%L,%L%F", 0xffff7fc0, 0x26187f80, ARCOMPACT, 0, 0 ,0,0},
  ...
  { "sub3%.f 0,%B,%C%F", 0xf8ff003f, 0x20190033, ARCOMPACT, 0, 0 ,0,0},
  ...
  { "sub3%.f%Q %A,%L,%L%F", 0xffff7fc0, 0x26197f80, ARCOMPACT, 0, 0, 0, 0},
  { "sub3%.f%Q 0,%L,%C%F", 0xffff703e, 0x2619703e, ARCOMPACT, 0, 0 ,0 ,0},
  { "sub3%.f%Q 0,%L,%u%F", 0xffff703e, 0x2659703e, ARCOMPACT, 0, 0 ,0 ,0},
...
/* MPYW & MPYUW -- 16-bit multiply instructions.  */
  ...
  /* RTSC */
  { "rtsc %B,0", 0x0, 0x306f001a, ARCOMPACT, 0, 0, 0, 0},
  { "rtsc 0,0",  0x0, 0x366f701a, ARCOMPACT, 0, 0, 0, 0},

  /* Android Extension Instructions */
  { "avgqb %A,%B,%C%F",     0x0, 0x30230000, ARCOMPACT, 0, 0, 0, 0},
  { "avgqb %A,%B,%u%F",     0x0, 0x30630000, ARCOMPACT, 0, 0, 0, 0},
  { "avgqb %A,%B,%L%F",     0x0, 0x30230f80, ARCOMPACT, 0, 0, 0, 0},
  { "avgqb %A,%L,%C%F",     0x0, 0x36237000, ARCOMPACT, 0, 0, 0, 0},
  { "avgqb%.q %#,%B,%C%F",  0x0, 0x30e30000, ARCOMPACT, 0, 0, 0, 0},
  { "avgqb%.q %#,%B,%u%F",  0x0, 0x30e30020, ARCOMPACT, 0, 0, 0, 0},
  { "avgqb%.q %#,%B,%L%F",  0x0, 0x30e30f80, ARCOMPACT, 0, 0, 0, 0},
  { "avgqb %#,%B,%K%F",     0x0, 0x30a30000, ARCOMPACT, 0, 0, 0, 0},
  { "addqbs %A,%B,%C%F",    0x0, 0x30240000, ARCOMPACT, 0, 0, 0, 0},
  { "addqbs %A,%B,%u%F",    0x0, 0x30640000, ARCOMPACT, 0, 0, 0, 0},
  { "addqbs %A,%B,%L%F",    0x0, 0x30240f80, ARCOMPACT, 0, 0, 0, 0},
  { "addqbs %A,%L,%C%F",    0x0, 0x36247000, ARCOMPACT, 0, 0, 0, 0},
  { "addqbs%.q %#,%B,%C%F", 0x0, 0x30e40000, ARCOMPACT, 0, 0, 0, 0},
  { "addqbs%.q %#,%B,%u%F", 0x0, 0x30e40020, ARCOMPACT, 0, 0, 0, 0},
  { "addqbs%.q %#,%B,%L%F", 0x0, 0x30e40f80, ARCOMPACT, 0, 0, 0, 0},
  { "addqbs %#,%B,%K%F",    0x0, 0x30a40000, ARCOMPACT, 0, 0, 0, 0},
  { "mpyqb %A,%B,%C%F",     0x0, 0x30250000, ARCOMPACT, 0, 0, 0, 0},
  { "mpyqb %A,%B,%u%F",     0x0, 0x30650000, ARCOMPACT, 0, 0, 0, 0},
  { "mpyqb %A,%B,%L%F",     0x0, 0x30250f80, ARCOMPACT, 0, 0, 0, 0},
  { "mpyqb %A,%L,%C%F",     0x0, 0x36257000, ARCOMPACT, 0, 0, 0, 0},
  { "mpyqb%.q %#,%B,%C%F",  0x0, 0x30e50000, ARCOMPACT, 0, 0, 0, 0},
  { "mpyqb%.q %#,%B,%u%F",  0x0, 0x30e50020, ARCOMPACT, 0, 0, 0, 0},
  { "mpyqb%.q %#,%B,%L%F",  0x0, 0x30e50f80, ARCOMPACT, 0, 0, 0, 0},
  { "mpyqb %#,%B,%K%F",     0x0, 0x30a50000, ARCOMPACT, 0, 0, 0, 0},
  { "pkqb %A,%B,%C%F",      0x0, 0x30200000, ARCOMPACT, 0, 0, 0, 0},
  { "pkqb %A,%B,%u%F",      0x0, 0x30600000, ARCOMPACT, 0, 0, 0, 0},
  { "pkqb %A,%B,%L%F",      0x0, 0x30200f80, ARCOMPACT, 0, 0, 0, 0},
  { "pkqb %A,%L,%C%F",      0x0, 0x36207000, ARCOMPACT, 0, 0, 0, 0},
  { "pkqb%.q %#,%B,%C%F",   0x0, 0x30e00000, ARCOMPACT, 0, 0, 0, 0},
  { "pkqb%.q %#,%B,%u%F",   0x0, 0x30e00020, ARCOMPACT, 0, 0, 0, 0},
  { "pkqb%.q %#,%B,%L%F",   0x0, 0x30e00f80, ARCOMPACT, 0, 0, 0, 0},
  { "pkqb %#,%B,%K%F",      0x0, 0x30a00000, ARCOMPACT, 0, 0, 0, 0},
  { "upkqb %A,%B,%C%F",     0x0, 0x30210000, ARCOMPACT, 0, 0, 0, 0},
  { "upkqb %A,%B,%u%F",     0x0, 0x30610000, ARCOMPACT, 0, 0, 0, 0},
  { "upkqb %A,%B,%L%F",     0x0, 0x30210f80, ARCOMPACT, 0, 0, 0, 0},
  { "upkqb %A,%L,%C%F",     0x0, 0x36217000, ARCOMPACT, 0, 0, 0, 0},
  { "upkqb%.q %#,%B,%C%F",  0x0, 0x30e10000, ARCOMPACT, 0, 0, 0, 0},
  { "upkqb%.q %#,%B,%u%F",  0x0, 0x30e10020, ARCOMPACT, 0, 0, 0, 0},
  { "upkqb%.q %#,%B,%L%F",  0x0, 0x30e10f80, ARCOMPACT, 0, 0, 0, 0},
  { "upkqb %#,%B,%K%F",     0x0, 0x30a10000, ARCOMPACT, 0, 0, 0, 0},
  { "fxtr %A,%B,%C%F",      0x0, 0x30260000, ARCOMPACT, 0, 0, 0, 0},
  { "fxtr %A,%B,%u%F",      0x0, 0x30660000, ARCOMPACT, 0, 0, 0, 0},
  { "fxtr %A,%B,%L%F",      0x0, 0x30260f80, ARCOMPACT, 0, 0, 0, 0},
  { "fxtr %A,%L,%C%F",      0x0, 0x36267000, ARCOMPACT, 0, 0, 0, 0},
  { "fxtr%.q %#,%B,%C%F",   0x0, 0x30e60000, ARCOMPACT, 0, 0, 0, 0},
  { "fxtr%.q %#,%B,%u%F",   0x0, 0x30e60020, ARCOMPACT, 0, 0, 0, 0},
  { "fxtr%.q %#,%B,%L%F",   0x0, 0x30e60f80, ARCOMPACT, 0, 0, 0, 0},
  { "fxtr %#,%B,%K%F",      0x0, 0x30a60000, ARCOMPACT, 0, 0, 0, 0},
  { "xpkqb %A,%B,%C%F",     0x0, 0x30220000, ARCOMPACT, 0, 0, 0, 0},
  { "xpkqb %A,%B,%u%F",     0x0, 0x30620000, ARCOMPACT, 0, 0, 0, 0},
  { "xpkqb %A,%B,%L%F",     0x0, 0x30220f80, ARCOMPACT, 0, 0, 0, 0},
  { "xpkqb %A,%L,%C%F",     0x0, 0x36227000, ARCOMPACT, 0, 0, 0, 0},
  { "xpkqb%.q %#,%B,%C%F",  0x0, 0x30e20000, ARCOMPACT, 0, 0, 0, 0},
  { "xpkqb%.q %#,%B,%u%F",  0x0, 0x30e20020, ARCOMPACT, 0, 0, 0, 0},
  { "xpkqb%.q %#,%B,%L%F",  0x0, 0x30e20f80, ARCOMPACT, 0, 0, 0, 0},
  { "xpkqb %#,%B,%K%F",     0x0, 0x30a20000, ARCOMPACT, 0, 0, 0, 0},
  { "acm %A,%B,%C%F",       0x0, 0x30280000, ARCOMPACT, 0, 0, 0, 0},
  { "acm %A,%B,%u%F",       0x0, 0x30680000, ARCOMPACT, 0, 0, 0, 0},
  { "acm %A,%B,%L%F",       0x0, 0x30280f80, ARCOMPACT, 0, 0, 0, 0},
  { "acm %A,%L,%C%F",       0x0, 0x36287000, ARCOMPACT, 0, 0, 0, 0},
  { "acm%.q %#,%B,%C%F",    0x0, 0x30e80000, ARCOMPACT, 0, 0, 0, 0},
  { "acm%.q %#,%B,%u%F",    0x0, 0x30e80020, ARCOMPACT, 0, 0, 0, 0},
  { "acm%.q %#,%B,%L%F",    0x0, 0x30e80f80, ARCOMPACT, 0, 0, 0, 0},
  { "acm %#,%B,%K%F",       0x0, 0x30a80000, ARCOMPACT, 0, 0, 0, 0},
  { "sfxtr %A,%B,%C%F",     0x0, 0x30290000, ARCOMPACT, 0, 0, 0, 0},
  { "sfxtr %A,%B,%u%F",     0x0, 0x30690000, ARCOMPACT, 0, 0, 0, 0},
  { "sfxtr %A,%B,%L%F",     0x0, 0x30290f80, ARCOMPACT, 0, 0, 0, 0},
  { "sfxtr %A,%L,%C%F",     0x0, 0x36297000, ARCOMPACT, 0, 0, 0, 0},
  { "sfxtr%.q %#,%B,%C%F",  0x0, 0x30e90000, ARCOMPACT, 0, 0, 0, 0},
  { "sfxtr%.q %#,%B,%u%F",  0x0, 0x30e90020, ARCOMPACT, 0, 0, 0, 0},
  { "sfxtr%.q %#,%B,%L%F",  0x0, 0x30e90f80, ARCOMPACT, 0, 0, 0, 0},
  { "sfxtr %#,%B,%K%F",     0x0, 0x30a90000, ARCOMPACT, 0, 0, 0, 0},
  { "clamp %A,%B,%C%F",     0x0, 0x302a0000, ARCOMPACT, 0, 0, 0, 0},
  { "clamp %A,%B,%u%F",     0x0, 0x306a0000, ARCOMPACT, 0, 0, 0, 0},
  { "clamp %A,%B,%L%F",     0x0, 0x302a0f80, ARCOMPACT, 0, 0, 0, 0},
  { "clamp %A,%L,%C%F",     0x0, 0x362a7000, ARCOMPACT, 0, 0, 0, 0},
  { "clamp%.q %#,%B,%C%F",  0x0, 0x30ea0000, ARCOMPACT, 0, 0, 0, 0},
  { "clamp%.q %#,%B,%u%F",  0x0, 0x30ea0020, ARCOMPACT, 0, 0, 0, 0},
  { "clamp%.q %#,%B,%L%F",  0x0, 0x30ea0f80, ARCOMPACT, 0, 0, 0, 0},
  { "clamp %#,%B,%K%F",     0x0, 0x30aa0000, ARCOMPACT, 0, 0, 0, 0},
  { "mpyu16 %A,%B,%C%F",    0x0, 0x302b0000, ARCOMPACT, 0, 0, 0, 0},
  { "mpyu16 %A,%B,%u%F",    0x0, 0x306b0000, ARCOMPACT, 0, 0, 0, 0},
  { "mpyu16 %A,%B,%L%F",    0x0, 0x302b0f80, ARCOMPACT, 0, 0, 0, 0},
  { "mpyu16 %A,%L,%C%F",    0x0, 0x362b7000, ARCOMPACT, 0, 0, 0, 0},
  { "mpyu16%.q %#,%B,%C%F", 0x0, 0x30eb0000, ARCOMPACT, 0, 0, 0, 0},
  { "mpyu16%.q %#,%B,%u%F", 0x0, 0x30eb0020, ARCOMPACT, 0, 0, 0, 0},
  { "mpyu16%.q %#,%B,%L%F", 0x0, 0x30eb0f80, ARCOMPACT, 0, 0, 0, 0},
  { "mpyu16 %#,%B,%K%F",    0x0, 0x30ab0000, ARCOMPACT, 0, 0, 0, 0},
  { "mpy16 %A,%B,%C%F",     0x0, 0x302c0000, ARCOMPACT, 0, 0, 0, 0},
  { "mpy16 %A,%B,%u%F",     0x0, 0x306c0000, ARCOMPACT, 0, 0, 0, 0},
  { "mpy16 %A,%B,%L%F",     0x0, 0x302c0f80, ARCOMPACT, 0, 0, 0, 0},
  { "mpy16 %A,%L,%C%F",     0x0, 0x362c7000, ARCOMPACT, 0, 0, 0, 0},
  { "mpy16%.q %#,%B,%C%F",  0x0, 0x30ec0000, ARCOMPACT, 0, 0, 0, 0},
  { "mpy16%.q %#,%B,%u%F",  0x0, 0x30ec0020, ARCOMPACT, 0, 0, 0, 0},
  { "mpy16%.q %#,%B,%L%F",  0x0, 0x30ec0f80, ARCOMPACT, 0, 0, 0, 0},
  { "mpy16 %#,%B,%K%F",     0x0, 0x30ac0000, ARCOMPACT, 0, 0, 0, 0},
  { "iaddr %A,%B,%C%F",     0x0, 0x30270000, ARCOMPACT, 0, 0, 0, 0},
  { "iaddr %A,%B,%u%F",     0x0, 0x30670000, ARCOMPACT, 0, 0, 0, 0},
  { "iaddr %A,%B,%L%F",     0x0, 0x30270f80, ARCOMPACT, 0, 0, 0, 0},
  { "iaddr %A,%L,%C%F",     0x0, 0x36277000, ARCOMPACT, 0, 0, 0, 0},
  { "iaddr%.q %#,%B,%C%F",  0x0, 0x30e70000, ARCOMPACT, 0, 0, 0, 0},
  { "iaddr%.q %#,%B,%u%F",  0x0, 0x30e70020, ARCOMPACT, 0, 0, 0, 0},
  { "iaddr%.q %#,%B,%L%F",  0x0, 0x30e70f80, ARCOMPACT, 0, 0, 0, 0},
  { "iaddr %#,%B,%K%F",     0x0, 0x30a70000, ARCOMPACT, 0, 0, 0, 0},
};
