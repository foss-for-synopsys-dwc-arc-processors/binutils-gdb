...
#define FP_LOAD(NAME, SIZE, D)						\
  { #NAME, FP_LOAD_ENCODING (SIZE, D), MSK_FP_LOAD, ARC_OPCODE_ARCV3, LOAD, \
    NONE, { FA, BRAKET, RB, SIMM9_8, BRAKETdup }, { C_AA27 } },		\
  { #NAME, FP_LSYM_ENCODING (SIZE, D), MSK_FP_SYM, ARC_OPCODE_ARCV3, LOAD, \
    NONE, { FA, BRAKET, LIMM, BRAKETdup }, FL_NONE },

#define FP_STORE(NAME, SIZE, D)						\
  { #NAME, FP_STORE_ENCODING (SIZE, D), MSK_FP_STORE, ARC_OPCODE_ARCV3, STORE, \
    NONE, { FA, BRAKET, RB, SIMM9_8, BRAKETdup }, { C_AA27 } },		\
  { #NAME, FP_SSYM_ENCODING (SIZE, D), MSK_FP_SYM, ARC_OPCODE_ARCV3, LOAD, \
    NONE, { FA, BRAKET, LIMM, BRAKETdup }, FL_NONE },
...
#define FMVF2I(NAME, OPS, BIT)				    \
  FMVF2I_INSN (#NAME, ARC_OPCODE_ARCV3, FLOAT, NONE, OPS,   \
	       BIT, ARG_64FP_CVF2I)
...
#define FMVI2F(NAME, OPS, BIT)				   \
  FMVI2F_INSN (#NAME, ARC_OPCODE_ARCV3, FLOAT, NONE, OPS,  \
	       BIT, ARG_64FP_CVI2F)
...
#define FP_RND(NAME, OPS, BIT)				   \
  FP_RND_INSN (#NAME, ARC_OPCODE_ARCV3, FLOAT, NONE, OPS,  \
	       BIT, ARG_64FP_1OP)
...
#define FP_CVF2F(NAME, OPS, BIT)				   \
  FP_CVF2F_INSN (#NAME, ARC_OPCODE_ARCV3, FLOAT, NONE, OPS,	   \
		 BIT, ARG_64FP_1OP)
...
#define FP_CVF2I(NAME, OPS, BIT)				   \
  FP_CVF2I_INSN (#NAME, ARC_OPCODE_ARCV3, FLOAT, NONE, OPS,	   \
		 BIT, ARG_64FP_CVF2I)
...
#define FP_CVI2F(NAME, OPS, BIT)				   \
  FP_CVI2F_INSN (#NAME, ARC_OPCODE_ARCV3, FLOAT, NONE, OPS,	   \
		 BIT, ARG_64FP_CVI2F)
...
#define FP_DOP(NAME, OPS, PRECISION)				   \
  FP_DOP_INSN (#NAME, ARC_OPCODE_ARCV3, FLOAT, NONE, DOPF_ ## OPS, \
...
#define FP_DOP_C(NAME, OPS, PRECISION)				    \
  FP_DOPC_INSN (#NAME, ARC_OPCODE_ARCV3, FLOAT, NONE, DOPF_ ## OPS, \
