...
{ "arcv.vwscmac.vx", 0, INSN_CLASS_XARCVVCPLX, "Vd,s,VtVm", MATCH_ARCV_VWSCMAC_VX, MASK_ARCV_VWSCMAC_VX, match_opcode, 0 },
{ "arcv.vwscnmsac.vv", 0, INSN_CLASS_XARCVVCPLX, "Vd,Vs,VtVm", MATCH_ARCV_VWSCNMSAC_VV, MASK_ARCV_VWSCNMSAC_VV, match_opcode, 0 },
{ "arcv.vwscnmsac.vx", 0, INSN_CLASS_XARCVVCPLX, "Vd,s,VtVm", MATCH_ARCV_VWSCNMSAC_VX, MASK_ARCV_VWSCNMSAC_VX, match_opcode, 0 },
{ "arcv.vwscjmac.vv", 0, INSN_CLASS_XARCVVCPLX, "Vd,Vs,VtVm", MATCH_ARCV_VWSCJMAC_VV, MASK_ARCV_VWSCJMAC_VV, match_opcode, 0 },
{ "arcv.vwscjmac.vx", 0, INSN_CLASS_XARCVVCPLX, "Vd,s,VtVm", MATCH_ARCV_VWSCJMAC_VX, MASK_ARCV_VWSCJMAC_VX, match_opcode, 0 },
{ "arcv.vwscjnmsac.vv", 0, INSN_CLASS_XARCVVCPLX, "Vd,Vs,VtVm", MATCH_ARCV_VWSCJNMSAC_VV, MASK_ARCV_VWSCJNMSAC_VV, match_opcode, 0 },
{ "arcv.vwscjnmsac.vx", 0, INSN_CLASS_XARCVVCPLX, "Vd,s,VtVm", MATCH_ARCV_VWSCJNMSAC_VX, MASK_ARCV_VWSCJNMSAC_VX, match_opcode, 0 },
