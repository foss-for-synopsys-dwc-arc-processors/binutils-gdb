...
/*BREQ */
{ (unsigned char *) "breq%.n%.è %B,%C,%d%ê",                 0xF8010017, 0x8010000, ARC_MACH_ARCV2, 0, 0, 0, 0},
{ (unsigned char *) "breq%.n%.è %B,%u,%d%ê",                 0xF8010017, 0x8010010, ARC_MACH_ARCV2, 0, 0, 0, 0},
{ (unsigned char *) "breq%.è%Q %B,%L,%d%ê",                  0xF8010FF7, 0x8010F80, ARC_MACH_ARCV2, 0, 0, 0, 0},
{ (unsigned char *) "breq%.è%Q %L,%C,%d%ê",                  0xFF017037, 0xE017000, ARC_MACH_ARCV2, 0, 0, 0, 0},
{ (unsigned char *) "breq%.è%Q %L,%u,%d%ê",                  0xFF017037, 0xE017010, ARC_MACH_ARCV2, 0, 0, 0, 0},
{ (unsigned char *) "breq%.è%Q %L,%L,%d%ê",                  0xFF017FF7, 0xE017F80, ARC_MACH_ARCV2, 0, 0, 0, 0},
/*BRNE */
{ (unsigned char *) "brne%.n%.è %B,%C,%d%ê",                 0xF8010017, 0x8010001, ARC_MACH_ARCV2, 0, 0, 0, 0},
{ (unsigned char *) "brne%.n%.è %B,%u,%d%ê",                 0xF8010017, 0x8010011, ARC_MACH_ARCV2, 0, 0, 0, 0},
{ (unsigned char *) "brne%.è%Q %B,%L,%d%ê",                  0xF8010FF7, 0x8010F81, ARC_MACH_ARCV2, 0, 0, 0, 0},
{ (unsigned char *) "brne%.è%Q %L,%L,%d%ê",                  0xFF017FF7, 0xE017F81, ARC_MACH_ARCV2, 0, 0, 0, 0},
{ (unsigned char *) "brne%.è%Q %L,%C,%d%ê",                  0xFF017037, 0xE017001, ARC_MACH_ARCV2, 0, 0, 0, 0},
{ (unsigned char *) "brne%.è%Q %L,%u,%d%ê",                  0xFF017037, 0xE017011, ARC_MACH_ARCV2, 0, 0, 0, 0},
/*BRLT */
{ (unsigned char *) "brlt%.n%.è %B,%C,%d%ê",                 0xF8010017, 0x8010002, ARC_MACH_ARCV2, 0, 0, 0, 0},
{ (unsigned char *) "brlt%.n%.è %B,%u,%d%ê",                 0xF8010017, 0x8010012, ARC_MACH_ARCV2, 0, 0, 0, 0},
{ (unsigned char *) "brlt%.è%Q %B,%L,%d%ê",                  0xF8010FF7, 0x8010F82, ARC_MACH_ARCV2, 0, 0, 0, 0},
{ (unsigned char *) "brlt%.è%Q %L,%L,%d%ê",                  0xFF017FF7, 0xE017F82, ARC_MACH_ARCV2, 0, 0, 0, 0},
{ (unsigned char *) "brlt%.è%Q %L,%C,%d%ê",                  0xFF017037, 0xE017002, ARC_MACH_ARCV2, 0, 0, 0, 0},
{ (unsigned char *) "brlt%.è%Q %L,%u,%d%ê",                  0xFF017037, 0xE017012, ARC_MACH_ARCV2, 0, 0, 0, 0},
/*BRGE */
{ (unsigned char *) "brge%.n%.è %B,%C,%d%ê",                 0xF8010017, 0x8010003, ARC_MACH_ARCV2, 0, 0, 0, 0},
{ (unsigned char *) "brge%.n%.è %B,%u,%d%ê",                 0xF8010017, 0x8010013, ARC_MACH_ARCV2, 0, 0, 0, 0},
{ (unsigned char *) "brge%.è%Q %B,%L,%d%ê",                  0xF8010FF7, 0x8010F83, ARC_MACH_ARCV2, 0, 0, 0, 0},
{ (unsigned char *) "brge%.è%Q %L,%L,%d%ê",                  0xFF017FF7, 0xE017F83, ARC_MACH_ARCV2, 0, 0, 0, 0},
{ (unsigned char *) "brge%.è%Q %L,%C,%d%ê",                  0xFF017037, 0xE017003, ARC_MACH_ARCV2, 0, 0, 0, 0},
{ (unsigned char *) "brge%.è%Q %L,%u,%d%ê",                  0xFF017037, 0xE017013, ARC_MACH_ARCV2, 0, 0, 0, 0},
/*BRLO */
{ (unsigned char *) "brlo%.n%.è %B,%C,%d%ê",                 0xF8010017, 0x8010004, ARC_MACH_ARCV2, 0, 0, 0, 0},
{ (unsigned char *) "brlo%.n%.è %B,%u,%d%ê",                 0xF8010017, 0x8010014, ARC_MACH_ARCV2, 0, 0, 0, 0},
{ (unsigned char *) "brlo%.è%Q %B,%L,%d%ê",                  0xF8010FF7, 0x8010F84, ARC_MACH_ARCV2, 0, 0, 0, 0},
{ (unsigned char *) "brlo%.è%Q %L,%L,%d%ê",                  0xFF017FF7, 0xE017F84, ARC_MACH_ARCV2, 0, 0, 0, 0},
{ (unsigned char *) "brlo%.è%Q %L,%C,%d%ê",                  0xFF017037, 0xE017004, ARC_MACH_ARCV2, 0, 0, 0, 0},
{ (unsigned char *) "brlo%.è%Q %L,%u,%d%ê",                  0xFF017037, 0xE017014, ARC_MACH_ARCV2, 0, 0, 0, 0},
/*BRHS */
{ (unsigned char *) "brhs%.n%.è %B,%C,%d%ê",                 0xF8010017, 0x8010005, ARC_MACH_ARCV2, 0, 0, 0, 0},
{ (unsigned char *) "brhs%.n%.è %B,%u,%d%ê",                 0xF8010017, 0x8010015, ARC_MACH_ARCV2, 0, 0, 0, 0},
{ (unsigned char *) "brhs%.è%Q %B,%L,%d%ê",                  0xF8010FF7, 0x8010F85, ARC_MACH_ARCV2, 0, 0, 0, 0},
{ (unsigned char *) "brhs%.è%Q %L,%L,%d%ê",                  0xFF017FF7, 0xE017F85, ARC_MACH_ARCV2, 0, 0, 0, 0},
{ (unsigned char *) "brhs%.è%Q %L,%C,%d%ê",                  0xFF017037, 0xE017005, ARC_MACH_ARCV2, 0, 0, 0, 0},
{ (unsigned char *) "brhs%.è%Q %L,%u,%d%ê",                  0xFF017037, 0xE017015, ARC_MACH_ARCV2, 0, 0, 0, 0},
